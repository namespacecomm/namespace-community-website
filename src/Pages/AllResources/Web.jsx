                ...
                <div class="lg:w-3/5 md:w-1/2 md:pr-10 md:py-6">
                  <div class="flex relative pb-12">
                    ...
                    <div class="flex-grow pl-4">
                      ...
                      <p class="leading-relaxed text-white text-justify">
                        A full-stack development comprises front-end, back-end,
                        and database management. Choosing a technology on which
                        you want to work depends on individuals, requirements,
                        and applications. Few technologies on which you can work
                        and are trending :- MERN AND MEAN
                      </p>
                    </div>
                  </div>
                  <div class="flex relative pb-12">
                    ...
                    <div class="flex-grow pl-4">
                      ...
                      <p class="leading-relaxed text-white text-justify">
                        Front-End is the UI (User Interface), it deals with the
                        website’s overall appearance, on how interactive and
                        dynamic it is. For mastering it, get clear with all the
                        elements of HTML, CSS, and JavaScript.
                      </p>
                    </div>
                  </div>
                  <div class="flex relative pb-12">
                    ...
                    <div class="flex-grow pl-4">
                      ...
                      <p class="leading-relaxed text-white text-justify">
                        ...
                        appropriate data from the client and receive it from the
                        server. Also, it includes the database which stores all
                        of the data of the application. It consists of three
                  ...
                  <div class="flex relative">
                    ...
                    <div class="flex-grow pl-4">
                      ...
                      <p class="leading-relaxed text-white text-justify">
                        When you’re all done with the theory part, do build some
                        projects to be well-versed with full-stack development.
                        You implement all the front-end, and back-end sides of a
                        project along with database handling, then you get
                        perfect in web development.
                      </p>
                    </div>
                  </div>
                </div>
