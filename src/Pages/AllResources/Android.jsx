              ...
              <div className="px-5 py-24 mx-auto flex flex-wrap">
                <div className="flex flex-wrap w-full">
                  ...
                  <img
                    ...
                    src="https://geekinformatic.com/wp-content/uploads/2020/09/Slider-3-V1.png"
                    alt="step"
                  />
                </div>
              </div>
                        ...
                        >
                          <div className="h-full flex items-center border-gray-200 border p-4 rounded-lg">
                            ...
                            <div className="flex-grow">
                              ...
                              <p className="text-white">{path.des}</p>
                              <input
                                type="checkbox"
                                id={path.title}
                                checked={checkedTopics[path.title]}
                                onChange={() =>
                                  handleCheckboxChange(path.title)
                                }
                              />
                            </div>
                          </div>
...
const androidDevelopmentPaths = [
  {
    ...
    to: "/native",
    des: "Native app development involves building Android apps using platform-specific languages like Java or Kotlin. It provides high performance and access to native device features.",
  },
  {
    ...
    to: "/cross-platform",
    des: "Cross-platform development allows you to create Android apps using a single codebase that can run on multiple platforms. Popular frameworks include Flutter, React Native, and Xamarin.",
  },
  {
    title: "Java",
    image:
    ...
    to: "/java",
    des: "Java is a widely used programming language for Android app development. It offers strong community support and a rich ecosystem of libraries and tools.",
  },
  {
    title: "Kotlin",
    image:
    ...
    to: "/kotlin",
    des: "Kotlin is the official language for Android app development. It's known for its conciseness and modern features, making it a preferred choice for many developers.",
  },
  {
    title: "Flutter",
    image:
    ...
    to: "/flutter",
    des: "Flutter is a popular open-source framework for building natively compiled applications for mobile, web, and desktop from a single codebase. It's great for cross-platform Android app development.",
