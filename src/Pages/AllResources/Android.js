							...
							<div className="lg:w-3/5 md:w-1/2 md:pr-10 md:py-6">
								<div className="flex relative pb-12">
									...
									<div className="flex-grow pl-4">
										...
										<p className="leading-relaxed text-white text-justify">
											...
											including native app development,
											cross-platform development, and more. Choose
											the one that aligns with your goals and project
											requirements. Some popular options include Java
											and Kotlin for native development and
											frameworks like Flutter for cross-platform
											development.
										</p>
									</div>
								</div>
								<div className="flex relative pb-12">
									...
									<div className="flex-grow pl-4">
										...
										<p className="leading-relaxed text-white text-justify">
											Android UI design is crucial for creating
											engaging and user-friendly apps. Familiarize
											yourself with XML layout files, Material Design
											guidelines, and best practices to create
								...
								<div className="flex relative">
									...
									<div className="flex-grow pl-4">
										...
										<p className="leading-relaxed text-white text-justify">
											Hands-on experience is key to becoming
											proficient in Android app development. Start by
											building small projects to practice your
											skills. As you progress, you can work on more
											complex apps and gain a deeper understanding of
											app architecture, databases, and user
											interactions.
										</p>
									</div>
								</div>
