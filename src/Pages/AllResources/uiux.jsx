            ...
            <div className="lg:w-3/5 md:w-1/2 md:pr-10 md:py-6">
              <div className="flex relative pb-12">
                ...
                <div className="flex-grow pl-4">
                  ...
                  <p className="leading-relaxed text-white text-justify">
                    Start by learning the foundational design principles such as
                    color theory, typography, layout, visual hierarchy, and
                    composition. There are many resources available online, such
                    as books, blogs, and online courses that can help you learn
                    these basics.
                  </p>
                </div>
              </div>
              <div className="flex relative pb-12">
                ...
                <div className="flex-grow pl-4">
                  ...
                  <p className="leading-relaxed text-white text-justify">
                    These tools simplify prototyping, making it possible to
                    create interactive mockups for user testing and feedback
                    collection, which in turn, accelerates the design iteration
                    process. Furthermore, they facilitate the creation of design
                    systems and style guides, promoting a cohesive and
                    user-friendly experience across different devices and
                    platforms.
                  </p>
                </div>
              </div>
              <div className="flex relative">
                ...
                <div className="flex-grow pl-4">
                  ...
                  <p className="leading-relaxed text-white text-justify">
                    Once you have a strong foundation in design principles,
                    focus on learning the specifics of UI/UX design. This can
                    involve studying user research, wireframing, prototyping,
                    usability testing, and other key concepts.
                  </p>
                </div>
              </div>
            </div>
        ...
        <div className="px-5 py-0 mx-auto">
          <div className="flex flex-col text-left w-full mb-10">
            ...
            <p className="w-full text-left mx-auto leading-relaxed text-base">
              UI/UX tools empower designers to deliver visually appealing and
              intuitive user interfaces while saving time, reducing costs, and
              improving the overall quality of digital products and services.
            </p>
          </div>
...
const uiuxTools = [
  ...
  },
  {
    ...
    image:
      "https://traffictail.com/wp-content/uploads/2023/05/Best-UIUX-Design-Tools16.png",
    description:
