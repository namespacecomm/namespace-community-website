...
const serviceData = [
    ...
    {
      image: 'https://miro.medium.com/v2/resize:fit:506/1*VKfs2PGyMm5FZfJD72kYCw.png',
    ...
    },
    {
      ...
      description: 'AWS Identity and Access Management (IAM) enables you to securely control access to AWS services and resources for your users.',
    },
    {
      image: 'https://miro.medium.com/v2/resize:fit:2570/1*YcNHxdrbPlV-lWjN_0Ek3g.png',
      description: 'Amazon Virtual Private Cloud (Amazon VPC) lets you provision a logically isolated section of the AWS Cloud where you can launch AWS resources into a virtual network.',
    },
  ];
            ...
            <div key={index} className="w-full sm:w-1/2 md:w-1/3 lg:w-1/3 p-4">
              <div className="bg-white shadow-lg rounded-lg overflow-hidden h-full">
                <div className="aspect-ratio-16/9">
                  <img src={service.image} alt="" className="object-cover w-full h-full" />
                </div>
                <div className="px-6 py-4">
                  <div className="font-bold text-xl mb-2">Service {index + 1}</div>
