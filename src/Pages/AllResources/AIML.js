                            ...
                            <div className="lg:w-3/5 md:w-1/2 md:pr-10 md:py-6">
                                <div className="flex relative pb-12">
                                    ...
                                    <div className="flex-grow pl-4">
                                        ...
                                        <p className="leading-relaxed text-white text-justify">
                                            Artificial Intelligence and Machine Learning encompass various domains, such as natural language processing, computer vision, and reinforcement learning. Choose a specific area of interest that aligns with your goals and explore its fundamentals.
                                        </p>
                                    </div>
                                </div>
                                <div className="flex relative pb-12">
                                    ...
                                    <div className="flex-grow pl-4">
                                        ...
                                        <p className="leading-relaxed text-white text-justify">
                                            Understanding machine learning algorithms is essential. Study supervised learning, unsupervised learning, and reinforcement learning algorithms. Dive into popular libraries like TensorFlow and PyTorch for hands-on experience.
                                        </p>
                                    </div>
                                </div>
                                <div className="flex relative">
                                    ...
                                    <div className="flex-grow pl-4">
                                        ...
                                        <p className="leading-relaxed text-white text-justify">
                                            Hands-on experience is key to mastering AI/ML. Start with small projects, like image classification or sentiment analysis, and gradually work on more complex projects. Learn about data preprocessing, model training, and evaluation.
                                        </p>
                                    </div>
                                </div>
                            </div>
                    ...
                    <div className="px-5 py-0 mx-auto">
                        ...
                        <div className="flex flex-wrap -m-2">
                            {aiMlDomains.map((domain) => (
                                <div key={domain.title} className="p-2 lg:w-1/3 md:w-1/2 w-full">
                ...
                <section className="mt-12">
                    <div className="px-5 py-0 mx-auto ">
                        <div className="flex flex-col text-left w-full mb-10">
                            ...
                            <p className="w-full text-left mx-auto leading-relaxed text-base">
                                Explore different machine learning frameworks that are widely used in the field. Each framework has its own strengths and capabilities for various ML tasks.
                            </p>
                        </div>
                        <div className="flex flex-wrap -m-2">
                            {mlFrameworks.map((framework) => (
                                <div key={framework.title} className="p-2 lg:w-1/3 md:w-1/2 w-full">
                                    <div className="h-full flex items-center border-gray-200 border p-4 rounded-lg">
                                        <img
                                            alt="framework"
                                            className="w-16 h-16 bg-gray-100 object-contain object-center flex-shrink-0 rounded-full mr-4"
...
const mlFrameworks = [
    {
        ...
        description: "TensorFlow is an open-source machine learning framework developed by Google. It's known for its flexibility and scalability, making it suitable for a wide range of ML tasks.",
        to: "/tensorflow",
    },
    {
        title: "PyTorch",
        image: "https://www.pngitem.com/pimgs/m/31-310639_pytorch-logo-png-transparent-png.png",
        description: "PyTorch is an open-source deep learning framework developed by Facebook's AI Research lab. It's popular for its dynamic computation graph and is widely used in research and industry.",
        to: "/pytorch",
    },
    {
        title: "Scikit-Learn",
        image: "https://vectorseek.com/wp-content/uploads/2023/02/Scikit-learn-Logo-Vector.jpg",
        description: "Scikit-Learn is a simple and efficient tool for data analysis and modeling. It provides easy-to-use interfaces for various ML algorithms and is suitable for beginners.",
        to: "/scikit-learn",
    },
    {
        title: "Keras",
        image: "https://w7.pngwing.com/pngs/571/118/png-transparent-keras-logo.png",
        description: "Keras is an open-source deep learning library that acts as an interface for TensorFlow, Theano, and CNTK. It's known for its user-friendly and high-level API.",
        to: "/keras",
    },
    {
        title: "Pandas",
        image: "https://pandas.pydata.org/static/img/pandas_mark.svg",
        description: "Pandas is an open-source data manipulation library for Python. It provides data structures and functions for working with structured data, making it essential for data preprocessing in ML.",
        to: "/pandas",
    },
    {
        title: "NumPy",
        image: "https://user-images.githubusercontent.com/50221806/86498201-a8bd8680-bd39-11ea-9d08-66b610a8dc01.png",
        description: "NumPy is a fundamental package for scientific computing with Python. It provides support for large, multi-dimensional arrays and matrices, along with mathematical functions.",
        to: "/numpy",
    },
    {
        title: "Matplotlib",
        ...
        description: "Matplotlib is a popular Python library for creating static, animated, and interactive visualizations in data analysis and machine learning projects.",
        to: "/matplotlib",
    },
];
