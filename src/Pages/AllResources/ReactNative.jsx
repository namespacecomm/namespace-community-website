                ...
                <div className="flex relative pb-12">
                  ...
                  <div className="flex-grow pl-4">
                    ...
                    <p className="leading-relaxed text-white text-justify">
                      ...
                      cross-platform mobile applications. If you're interested in
                      becoming a React Native developer, you can choose from
          ...
          <div className="px-5 py-0 mx-auto">
            <div className="flex flex-col text-left w-full mb-10">
              ...
              <p className="w-full text-left mx-auto leading-relaxed text-base">
                React Native development offers various paths, including The Mobile
...
const reactNativeDevelopmentPaths = [
  ...
  },
  {
    ...
    image:
      "https://softflame.in/images/cross2.png",
    description:
...
const reactNativeResources = [
  {
    ...
    image: "https://cdn1.iconfinder.com/data/icons/soleicons-fill-vol-1/64/reactjs_javascript_library_atom_atomic_react-512.png",
