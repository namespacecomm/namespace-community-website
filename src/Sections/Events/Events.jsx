            ...
            <VerticalTimelineElement
              ...
              >
                <h3 className="vertical-timeline-element-title font-bold">
                  NSCC BPIT Conducted its Second Annual Orientation 2023 for the new batch of 2027 students
                </h3>
              ...
              >
                <h3 className="vertical-timeline-element-title font-bold">
                  NSCC BPIT Completes 1 one year of its tremendous journey as a technical community
                </h3>
                <h4 className="vertical-timeline-element-subtitle">
                  Bhagwan Parshuram Institute of Technology
                </h4>
